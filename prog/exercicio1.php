...
$tecnico = new Tecnico("Fulano da Silva", 4500, "T310", 500);
$tecnico->exibeDados();

echo "\n FUNCIONÁRIO ADMINISTRATIVO (NOITE) \n";
$admNoite = new Administrativo("Ciclano Santos", 1800, "A303", "noite", 300);
$admNoite->exibeDados();

echo "\n FUNCIONÁRIO ADMINISTRATIVO (DIA) \n";
$admDia = new Administrativo("Beltrano Souza", 3000, "A401", "dia");
$admDia->exibeDados();
