...
class Novo extends Imovel {
    ...
    public function imprimeAdicional() {
        echo "Adicional pela condição de novo do imóvel: R$ " . number_format($this->adicional, 2, ',', '.') . "\n";
    }
...
class Velho extends Imovel {
    ...
    public function imprimeDesconto() {
        echo "Desconto por condição de velhice do imóvel: R$ " . number_format($this->desconto, 2, ',', '.') . "\n";
    }
...
echo " IMÓVEL NOVO \n";
$novo = new Novo("Rua Equador, 323", 300000.00, 35000.00);
$novo->imprimeDados();

echo "\n IMÓVEL VELHO \n";
$velho = new Velho("Rua Chile, 777", 300000.00, 30000.00);
$velho->imprimeDados();
?>