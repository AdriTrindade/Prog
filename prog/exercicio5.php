...
$admin = new Administrativo("Henrique", 3000, "A456");
$tecnico = new Tecnico("Laís", 3200, "T538");
...
echo "\n b) Cachorro e Gato \n";
$dog = new Cachorro("Theo", "Buldogue");
$cat = new Gato("Pelúcia", "Angorá");
echo $dog->late() . "\n";
echo $dog->caminha() . "\n";
echo $cat->mia() . "\n";
echo $cat->caminha() . "\n";
...
$rica = new Rica("Giovana", 30, 100000);
$pobre = new Pobre("Roberta", 25);
$miseravel = new Miseravel("Henrique", 50);
...
if ($tipoImovel == 1) {
    $novo = new Novo("Rua Equador", 300000, 25000);
    echo "Imóvel Novo - Preço final: R$ " . number_format($novo->precoFinal(), 2, ',', '.') . "\n";
} elseif ($tipoImovel == 2) {
    $velho = new Velho("Rua Chile", 300000, 15000);
